...
//        method_exchangeImplementations(originalMethod, swizzledMethod);
        ...
        IMP impSwizzle = method_getImplementation(swizzledMethod);
        method_setImplementation(originalMethod, impSwizzle);
        method_setImplementation(swizzledMethod, impOriginal);
    }
}
