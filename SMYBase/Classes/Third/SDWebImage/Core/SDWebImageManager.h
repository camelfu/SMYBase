 ...
 */
@property (nonatomic, class, nullable, strong) id<SDImageCache> defaultImageCache;
 ...
 */
@property (nonatomic, class, nullable, strong) id<SDImageLoader> defaultImageLoader;
